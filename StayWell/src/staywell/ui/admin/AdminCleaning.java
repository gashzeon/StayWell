...
public class AdminCleaning extends Layout {
	...
	public AdminCleaning() {
		...
		JLabel lblLaundryServices = new JLabel("HouseKeeping Services");
		lblLaundryServices.setFont(new Font("Candara", Font.BOLD, 30));
		lblLaundryServices.setBounds(362, 42, 300, 36);
		add(lblLaundryServices);
		
		super.setLayout();
	}
	public AdminCleaning(Frame2 frame)
	{
		this();
		f = frame;
	}
