...
public class AdminBallRoom extends Layout {
	...
	public AdminBallRoom() {
		...
		table.setModel(new DefaultTableModel(
			...
			new String[] {
				"Membership No", "Type Selected", "Day Selected", "Month Selected", "Year Selected", "Time Start", "Time End"
			}
		) {
		...
		JLabel lblLaundryServices = new JLabel("Ball Room Reservation");
	...
	public AdminBallRoom(Frame2 frame)
	{
		this();
		f =frame;
	}
