	...
	public Restaurant(MainFrame frame) {
		...
		Confirm.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				staywell.entities.Restaurant restaurant = new staywell.entities.Restaurant();
			}
		});
		Confirm.setIcon(new ImageIcon(Restaurant.class
				.getResource("/staywell/image/cashing70X70.png")));
		Confirm.setBounds(514, 598, 70, 70);
		add(Confirm);
...
class MyTableModel extends AbstractTableModel {
			...
			private String[] columnNames = { "Select", 
									  	     ...
									  	     "Time End"};
		    private Object[][] data = {
					{new Boolean(false), "Aston's", "DD/MM/YY", "0915", "1045"},
					{new Boolean(false), "Oceania", "DD/MM/YY", "0930", "1115"},
					{new Boolean(false), "Indie's Rock", "DD/MM/YY", "1015", "1215"},
					{new Boolean(false), "Veggie Fresh", "DD/MM/YY", "1030", "1230"},
					{new Boolean(false), "Hotel", "DD/MM/YY", "1045", "1315"},
					};
