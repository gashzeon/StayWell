...
//
    ...
    private java.awt.image.BufferedImage createNightDayImage()
    {
        ...
        g2.setStroke(new java.awt.BasicStroke(IMAGE.getWidth() * 0.015f, java.awt.BasicStroke.CAP_ROUND, java.awt.BasicStroke.JOIN_ROUND));

        final java.awt.geom.Point2D SUN_CENTER = new java.awt.geom.Point2D.Double(IMAGE.getWidth() * 0.49, IMAGE.getHeight() * 0.86206);
        final java.awt.geom.Point2D SUNBEAM_STOP = new java.awt.geom.Point2D.Double(IMAGE.getWidth() * 0.49, IMAGE.getHeight() * 0.86206 - IMAGE.getWidth() * 0.15);

        final float[] SUNBEAM_FRACTIONS =
        {
            0.0f,
            1.0f
        };
        final java.awt.Color[] SUNBEAM_COLORS =
        {
            new java.awt.Color(0.94117f, 0.74509f, 0.14901f, 1.0f),
            new java.awt.Color(0.94117f, 0.74509f, 0.14901f, 0.2f)
        };

        final java.awt.LinearGradientPaint SUNBEAM_GRADIENT = new java.awt.LinearGradientPaint(SUN_CENTER, SUNBEAM_STOP, SUNBEAM_FRACTIONS, SUNBEAM_COLORS);
        g2.setPaint(SUNBEAM_GRADIENT);
        for (int alpha = 0 ; alpha < 360 ; alpha += 15)
        {
            g2.rotate(Math.toRadians(alpha), IMAGE.getWidth() * 0.49, IMAGE.getHeight() * 0.86206);
            g2.draw(new java.awt.geom.Line2D.Double(SUN_CENTER, SUNBEAM_STOP));
